                  ...
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-md-6 order-2 order-md-1">
                        <div class="card-body">
                          <h4 class="card-title mb-4">Felicidades <span class="fw-bold"><?php echo $nombres ?>!</span> 🎉</h4>
                          <p class="mb-0">Haz inciado en Ecuacompus.</p>
                          <p>Sistema masivo de mensajes.</p>
                        </div>
                      </div>
