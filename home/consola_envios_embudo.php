...
<html
  ...
  <head>
    ...
    <title>Consola de Campañas Embudo de Ventas  </title>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header table-card-header">
                                <h5>Realizar Campañas Embudo de Ventas</h5>
                            </div>
     ...
     '; ?>
                                ...
                                <div class="row">
                                 ...
                                 <div class="form-group">
                                   <label class="label-guibis-sm">Tipo Embudo</label>
                                   <select class="form-control input-guibis-sm" name="tipo_embudo" required id="tipo_embudo">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <select class="form-control input-guibis-sm" name="numero_extra" required id="numero_guibis">
                                 ...
                                 <input type="hidden" name="metodo_envio" value="embudo_ventas">
                                  <input type="hidden" name="action" value="iniciar_campana">
                                  <style media="screen">
                                    .alerta_inicio_campana{
                                      text-align: center;
                                    }
                                  </style>
