...
<html
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <button class="btn btn-secondary create-new btn-primary waves-effect waves-light" type="button" id="boton_agregar_cliente">
                <span>
                  ...
                  <span class="d-none d-sm-inline-block">Agregar Nueva Variable</span>
                </span>
              </button>
              ...
              <!-- Modal to add new record -->
                               ...
                               <div class="modal-dialog">
                                 <div class="modal-content">
                                   <div class="modal-header header_guibis" style="background-color: #263238;">
                                     <h5 class="modal-title" id="proveedorModalLabel">Agregar Variables Globales</h5>
                                   ...
                                   <div class="modal-body">
                                     ...
                                     <form action=""  id="add_cliente" >
                                       <div class="mb-3">
                                         <label class="label-guibis-sm">Agregue la variables separados por coma (,) </i></label>
                                         <textarea class="form-control input-guibis-sm"   name="variables" id="texto" rows="3"></textarea>
                                       </div>

                                         <div class="modal-footer">
                                           <input type="hidden" name="action" value="agregar_variables_entorno">
                                           <button type="button" class="btn btn-danger mobtn" data-bs-dismiss="modal">Cerrar <i class="fas fa-times-circle"></i></button>
                                           <button type="submit" class="btn btn-primary">Agregar Variables Globales <i class="fas fa-plus"></i></button>
                                         </div>
                             ...
                             <div class="modal fade" id="modal_editar_cliente" tabindex="-1" aria-labelledby="proveedorModalLabel" aria-hidden="true">
                               <div class="modal-dialog">
                                 <div class="modal-content">
                                   <div class="modal-header header_guibis" style="background-color: #263238;">
                                     <h5 class="modal-title" id="proveedorModalLabel">Editar Variable Entorno  </h5>
                                     <button type="button" class="btn-danger" data-bs-dismiss="modal"><i class="fas fa-times-circle"></i>  </button>
                                   </div>
                                   <div class="modal-body">
                                     ...
                                     <form action=""  id="update_cliente" >
                                       ...
                                       <div class="mb-3">
                                         <label class="label-guibis-sm">Agregue la variables separados por coma (,) </i></label>
                                         <textarea class="form-control input-guibis-sm"   name="variables" id="variables_edit" rows="3"></textarea>
                                       </div>
                                         <div class="modal-footer">
                                           <input type="hidden" name="action" value="editar_clientes">
                                           <input type="hidden" name="id_cliente" id="id_cliente" value="">
                                           <button type="button" class="btn btn-danger mobtn" data-bs-dismiss="modal">Cerrar <i class="fas fa-times-circle"></i></button>
                                           <button type="submit" class="btn btn-primary">Editar Variable Entorno</button>
                                         </div>
    ...
    <script type="text/javascript" src="mensajeria/variables_gloables.js?v=2"></script>
