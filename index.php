    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
          ...
          <div class="swiper-logo-carousel pt-lg-4 mt-12">
            <div class="swiper" id="swiper-clients-logos">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img
                    src="/assets/img/front-pages/branding/logo-1-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="/assets/img/front-pages/branding/logo-2-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="/assets/img/front-pages/branding/logo-3-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="/assets/img/front-pages/branding/logo-4-light.png"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="/assets/img/front-pages/branding/logo-5-light.png"
                    alt="client logo"
                    class="client-logo"
      ...
      <section id="landingPricing" class="section-py bg-body landing-pricing">
        <div class="container bg-icon-left position-relative">
          ...
          <h5 class="text-center mb-2">
            <span class="display-5 fs-4 fw-bold">Tailored pricing plans</span> designed for you
          </h5>
                ...
                <div class="card-body p-6 p-sm-8 pt-0">
                  <ul class="list-unstyled">
                    <li>
                      <h5 class="mb-3">
                        <img
                          src="/assets/img/front-pages/icons/list-arrow-icon.png"
                          alt="list arrow icon"
          ...
          <div class="row gx-0 gy-6 gx-sm-6">
            ...
            <div class="col-md-3 col-sm-6 text-center">
              <span class="badge rounded-pill bg-label-hover-info fun-facts-icon mb-6 p-5"
                ><i class="tf-icons ri-award-line ri-42px"></i
              ></span>
      ...
      <section id="landingCTA" class="section-py landing-cta p-lg-0 pb-0 position-relative">
        <img
          src="/assets/img/front-pages/backgrounds/cta-bg.png"
          ...
          <div class="row align-items-center gy-5 gy-lg-0">
            <div class="col-lg-6 text-center text-lg-start">
              ...
              <a href="payment-page.html" class="btn btn-primary"
                >Get Started<i class="ri-arrow-right-line ri-16px ms-2 scaleX-n1-rtl"></i
              ></a>
            </div>
